 ...
 * @author t2-sheedy
 */
//public class Authenticator {//NOT SURE WHEN APPLICABLE, NOT CALLED WITHIN LOGINCONTROLLER
...
//            String query = GetAuthenticateQuery(username, password);
//            if (query.length() > 0) {
//
...
//    }
//
//    public static String GetAuthenticateQuery(String registration, String password) {
//        String query = "SELECT * FROM Drivers WHERE Registration = '" + registration + "' AND password = '" + password + "';";
//       return query;
//    }
//
//}
